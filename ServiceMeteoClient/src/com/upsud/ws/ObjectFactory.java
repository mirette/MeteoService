 ...
 * generated in the com.upsud.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetData_QNAME = new QName("http://ws.upsud.com/", "getData");
    private final static QName _GetDataResponse_QNAME = new QName("http://ws.upsud.com/", "getDataResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.upsud.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.upsud.com/", name = "getData")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.upsud.com/", name = "getDataResponse")
